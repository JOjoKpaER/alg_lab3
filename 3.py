...
def reverse_iter(ulist):
    ret = UnorderedList()
    while True:
        try:
            ret.append(ulist.pop())
        except Exception:
            break
    return ret


def reverse_rec(ulist_from, ulist_to):
    try:
        ulist_to.append(ulist_from.pop())
        reverse_rec(ulist_from, ulist_to)
    except Exception:
        return
...
mylistReversed = UnorderedList()

reverse_rec(mylist, mylistReversed)
print(str(mylistReversed))
